...
def compute_mwega_1779417203_006(open_df, high_df, low_df, close_df, volume_df) -> pd.DataFrame:
    def _b(x):
    ...
    event_restart_big_up = ((ret1 >= 0.045) & (close_pos >= 0.70)).astype(float)
    result = event_restart_big_up
